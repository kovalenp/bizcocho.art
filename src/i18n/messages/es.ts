export const messages = {
  ...
  booking: {
    ...
    successMessage: 'Tu pago ha sido procesado correctamente. Te hemos enviado un correo de confirmación con todos los detalles.',
    whatsNext: '¿Qué sigue?',
    checkEmail: 'Revisa tu correo para ver los detalles de la reserva y el recibo',
    arriveEarly: 'Guarda la fecha y llega 10 minutos antes',
    cancellationPolicy: 'Contáctanos si necesitas cancelar o reprogramar (se requieren 48 horas de antelación)',
    browseMore: 'Ver Más Clases',
