export const messages = {
  ...
  booking: {
    ...
    successMessage: 'Your payment has been processed successfully. We\'ve sent a confirmation email with all the details to your email address.',
    whatsNext: 'What\'s next?',
    checkEmail: 'Check your email for booking details and receipt',
    arriveEarly: 'Save the date and arrive 10 minutes early',
    cancellationPolicy: 'Contact us if you need to cancel or reschedule (48 hours notice required)',
    browseMore: 'Browse More Classes',
